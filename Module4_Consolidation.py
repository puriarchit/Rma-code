...
def main():
    ...
    logging.info("Lookup tables ready in %.2f seconds.", time.time() - step_start)
    ...
    logging.info("=== Module 4 completed in %.2f minutes [Finished at %s] (Total Consolidated Rows: %d) ===", elapsed_min, end_time_str, row_count)
