...
try:
    ...
    cursor.execute("""
        CREATE TABLE NegativeList_History (
            ...
            VersionID NVARCHAR(15) NULL, EntityType NUMERIC(2,0) NULL, Source NVARCHAR(255) NULL, OriginalSource NVARCHAR(4000) NULL,
    ...
    cursor.execute("""
        CREATE TABLE NegativeList_Temp(
            ...
            OriginalSource [nvarchar](4000) NULL, Remark [nvarchar](4000) NULL, NationalIDInfo [nvarchar](250) NULL,
    ...
    cursor.execute("""
        CREATE TABLE [NegativeList_Update_INC] (
            ...
            [WLType] nvarchar(200), [OriginalSource] nvarchar(4000), [Remark] nvarchar(4000), [NationalIDInfo] nvarchar(250), 
